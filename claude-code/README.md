...
This integration covers ANSI terminal colors, not Claude web or desktop. Arbitrary backgrounds still depend on terminal contrast safeguards; see [VALIDATION.md](../VALIDATION.md).
