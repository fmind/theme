...
A light theme for everyday code and terminal work, with 60 app integrations. One folder per app, native theme files, no generator.
...
Use one of the matching terminal themes for ANSI colors. Normal and bright slots use dark foregrounds, including slots named white.
