...
| GTK | [package and installation](gtk/README.md) | Copy the complete directory to `~/.themes/Fmind/` and select Fmind in your GTK theme chooser. Includes GTK 2, GTK 3.20+ and GTK 4 widgets; desktop-shell companions remain pending. |
