...
The [free Dracula GTK repository](https://github.com/dracula/gtk) also contains desktop-shell and window-manager themes. The existing companions below remain supported; SDDM runtime validation is unfinished. Full upstream free-catalog coverage is planned in the [root roadmap](../TODO.md); this bundle’s unfinished runtime checks remain pending.
